...
export default function SinksFaucetsPage() {
    const services = [
        "Faucet installation",
        "Faucet repair",
        "Sink installation",
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="font-['Montserrat'] font-bold text-white text-4xl md:text-5xl lg:text-6xl mb-6">
                                    Sinks & Faucets <span className="text-[#c9a05f]">Installation & Repair</span>
                                </h1>
                                <p className="font-['Open_Sans'] text-[#e8e4dc] text-lg md:text-xl leading-relaxed mb-8">
                                    Professional sink and faucet installation and repair services for kitchens and bathrooms.
                                </p>
                                <a
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                            <div className="lg:sticky lg:top-[120px]">
                                <h2 className="font-['Montserrat'] font-bold text-[#1a2332] text-3xl md:text-4xl mb-6">Request Sink & Faucet Service</h2>
                                <p className="font-['Open_Sans'] text-[#4a5568] text-lg leading-relaxed mb-8">Professional sink and faucet installation and repair services for kitchens and bathrooms.</p>
                                    ...
                                    {services.slice(0, 3).map((s, i) => (
                                        <div key={i} className="flex items-start gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="font-['Open_Sans'] text-[#4a5568]">Reliable {s.toLowerCase()} services.</p>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                ...
                <section className="py-16 md:py-24 bg-gradient-to-r from-[#1a2332] to-[#2c3e50]">
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        <h2 className="font-['Montserrat'] font-bold text-white text-3xl md:text-4xl mb-6">
                            Need Sink or Faucet Service?
                        </h2>
                        <p className="font-['Open_Sans'] text-[#e8e4dc] text-lg mb-8 leading-relaxed">
                            Contact us for professional sink and faucet installation and repair services.
                        </p>
                        <a
                            href="tel:909-623-0033"
