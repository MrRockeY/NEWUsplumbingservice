                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="font-['Montserrat'] font-bold text-white text-4xl md:text-5xl lg:text-6xl mb-6">
                                    Advanced <span className="text-[#c9a05f]">Slab Leak Detection</span>
                                </h1>
                                <p className="font-['Open_Sans'] text-[#e8e4dc] text-lg md:text-xl leading-relaxed mb-8">
                                    State-of-the-art leak detection technology to locate and repair slab leaks before they cause major foundation damage.
                                </p>
                                <a
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                            <div className="lg:sticky lg:top-[120px]">
                                <h2 className="font-['Montserrat'] font-bold text-[#1a2332] text-3xl md:text-4xl mb-6">
                                    Request Slab Leak Detection Service
                                </h2>
                                <p className="font-['Open_Sans'] text-[#4a5568] text-lg leading-relaxed mb-8">
                                    Our expert team uses state-of-the-art equipment to accurately detect and diagnose slab leaks. Fill out the form and we'll get back to you quickly to schedule your service.
                                </p>

                                <div className="space-y-6">
                                    <div className="flex items-start gap-4">
                                        <div className="w-10 h-10 bg-[#c9a05f] rounded-full flex items-center justify-center flex-shrink-0 text-white font-bold">1</div>
                                        <div>
                                            <h3 className="font-['Montserrat'] font-bold text-[#1a2332] mb-2">Submit Your Request</h3>
                                            <p className="font-['Open_Sans'] text-[#4a5568]">Fill out the form with your contact details and service needs.</p>
                                        </div>
                                    </div>

                                    <div className="flex items-start gap-4">
                                        <div className="w-10 h-10 bg-[#c9a05f] rounded-full flex items-center justify-center flex-shrink-0 text-white font-bold">2</div>
                                        <div>
                                            <h3 className="font-['Montserrat'] font-bold text-[#1a2332] mb-2">Quick Response</h3>
                                            <p className="font-['Open_Sans'] text-[#4a5568]">We'll contact you promptly to confirm details and schedule service.</p>
                                        </div>
                                    </div>

                                    <div className="flex items-start gap-4">
                                        <div className="w-10 h-10 bg-[#c9a05f] rounded-full flex items-center justify-center flex-shrink-0 text-white font-bold">3</div>
                                        <div>
                                            <h3 className="font-['Montserrat'] font-bold text-[#1a2332] mb-2">Expert Service</h3>
                                            <p className="font-['Open_Sans'] text-[#4a5568]">Our skilled technicians will arrive on time and solve your slab leak issues.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <section className="py-16 md:py-24 bg-gradient-to-r from-[#1a2332] to-[#2c3e50]">
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        ...
                        <p className="font-['Open_Sans'] text-[#e8e4dc] text-lg mb-8 leading-relaxed">
                            Don't wait! Early detection can save you thousands in foundation repairs.
                        </p>
                        <a
                            href="tel:909-623-0033"
