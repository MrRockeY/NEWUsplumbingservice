                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="font-['Montserrat'] font-bold text-white text-4xl md:text-5xl lg:text-6xl mb-6">
                                    Bathtubs & Showers <span className="text-[#c9a05f]">Service</span>
                                </h1>
                                <p className="font-['Open_Sans'] text-[#e8e4dc] text-lg md:text-xl leading-relaxed mb-8">
                                    Complete bathtub and shower installation, repair, and remodeling services.
                                </p>
                                <a
                            ...
                            <div className="relative">
                                <Image
                                    ...
                                    alt="Bathtubs and Showers Service"
                                    width={400}
                                    height={400}
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                            <div className="lg:sticky lg:top-[120px]">
                                <h2 className="font-['Montserrat'] font-bold text-[#1a2332] text-3xl md:text-4xl mb-6">Request Bathtub & Shower Service</h2>
                                <p className="font-['Open_Sans'] text-[#4a5568] text-lg leading-relaxed mb-8">Complete bathtub and shower installation, repair, and remodeling services.</p>
                                    ...
                                    {services.slice(0, 3).map((s, i) => (
                                        <div key={i} className="flex items-start gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="font-['Open_Sans'] text-[#4a5568]">Professional {s.toLowerCase()} solutions.</p>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                ...
                <section className="py-16 md:py-24 bg-gradient-to-r from-[#1a2332] to-[#2c3e50]">
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        <h2 className="font-['Montserrat'] font-bold text-white text-3xl md:text-4xl mb-6">
                            Need Bathtub or Shower Service?
                        </h2>
                        <p className="font-['Open_Sans'] text-[#e8e4dc] text-lg mb-8 leading-relaxed">
                            Contact us for professional bathtub and shower installation and repair services.
                        </p>
                        <a
                            href="tel:909-623-0033"
